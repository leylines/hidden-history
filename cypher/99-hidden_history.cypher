...
MATCH  (s:place {name: 'Vatican City'}),(d:organization {name: 'Holy See'}) CREATE (s)-[:belongs_to {status: 'proven'}]->(d);
...
MATCH  (s:artificial {name: 'Einsiedeln Abbey'}),(d:place {name: 'Einsiedeln'}) CREATE (s)-[:located {status: 'proven'}]->(d);
...
MATCH  (s:tribe {name: 'Khazars'}),(d:empire {name: 'Khazaria'}) CREATE (s)-[:member_of {status: 'unproven'}]->(d);
...
MATCH  (s:person {name: 'Plato'}),(d:artificial {name: 'Library of Alexandria'}) CREATE (s)-[:located {status: 'unproven'}]->(d);
...
MATCH  (s:knowledge {name: 'Atlantean knowledge'}),(d:artificial {name: 'Library of Alexandria'}) CREATE (s)-[:located {status: 'proven'}]->(d);
...
MATCH  (s:belief {name: 'Classical Greek philosophy'}),(d:belief {name: 'Byzantine philosophy'}) CREATE (s)-[:succesor {status: 'proven'}]->(d);
MATCH  (s:belief {name: 'Christianity'}),(d:belief {name: 'Byzantine philosophy'}) CREATE (s)-[:succesor {status: 'proven'}]->(d);
MATCH  (s:belief {name: 'Paulicianism'}),(d:belief {name: 'Christianity'}) CREATE (s)-[:follows {status: 'proven'}]->(d);
MATCH  (s:belief {name: 'Catharism'}),(d:belief {name: 'Christianity'}) CREATE (s)-[:follows {status: 'proven'}]->(d);
MATCH  (s:belief {name: 'Paulicianism'}),(d:belief {name: 'Catharism'}) CREATE (s)-[:succesor {status: 'proven'}]->(d);
